...
cartRouter.put('/:cid', passport.authenticate('jwt', { session: false }), cartController.updateCart)

cartRouter.delete('/:cid', passport.authenticate('jwt', { session: false }), cartController.emptyCart)

cartRouter.post('/:cid/:pid', passport.authenticate('jwt', { session: false }), cartController.insertProductCart)

cartRouter.put('/:cid/:pid', passport.authenticate('jwt', { session: false }), cartController.updateQuantity)

cartRouter.delete('/:cid/:pid', passport.authenticate('jwt', { session: false }), cartController.deleteProductCart)

cartRouter.get('/purchase/:cid',  passport.authenticate('jwt', { session: false }), cartController.createTicket)
